...
const User = require('../model/Users'); // Replace with your model
...
const seedDatabase = async () => {
  try {
    ...
    await User.insertMany(usersData, { maxTimeMS: 20000 }); // Set the timeout to 20 seconds (20000 milliseconds)
    await OverallStat.insertMany(dataOverallStat, { maxTimeMS: 20000 });
